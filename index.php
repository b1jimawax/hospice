...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">+241 077582104</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">hospice@email.com</span>
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">Hospice</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#department-section" class="nav-link"><span>Spécialités</span></a></li>
	          <li class="nav-item"><a href="#doctor-section" class="nav-link"><span>Nos spécialistes</span></a></li>
	          <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Contactez-nous</span></a></li>
	          <li class="nav-item cta mr-md-2"><a href="pages/samples/login.php" class="nav-link" style="border-radius: 30px;">Connexion</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
	        <div class="col-md-7 py-5">
		      ...
		      <div class="col-md-5 d-flex" id="consultations">
	        	<div class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center">
		        	<form action="traitement.php" method="post" class="appointment-form ftco-animate">
		        		<h3>Formulaire de reservation</h3>
		    				<div class="">
			    				<div class="form-group">
			    					<input type="text" id="nom" name="nom" class="form-control" placeholder="First Name" required>
			    				</div>
			    				<div class="form-group">
			    					<input type="text" id="prenom" name="prenom" class="form-control" placeholder="Last Name" required>
			    				</div>
								<div class="form-group">
			            ...
			            <div class="form-group">
			              <input type="submit" value="Reserver une consultation" class="btn btn-secondary py-3 px-4">
			            </div>
		    				</div>
		    			</form>
		    		</div>
    ...
    <section class="ftco-intro img" style="background-image: url(images/bg_2.jpg);">
		...
		<section class="ftco-section" id="doctor-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4">Nos spécialistes</h2>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tous droits réservés |  <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="#" target="_blank">BenjiMawax</a>
